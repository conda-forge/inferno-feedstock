About inferno-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/inferno-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=451&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/inferno-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `inferno` can be installed with `conda`:
...
```
mamba install inferno
```

It is possible to list all of the versions of `inferno` available on your platform with `conda`:
...
```
mamba search inferno --channel conda-forge
```
...
mamba repoquery search inferno --channel conda-forge

# List packages depending on `inferno`:
mamba repoquery whoneeds inferno --channel conda-forge

# List dependencies of `inferno`:
mamba repoquery depends inferno --channel conda-forge
```
